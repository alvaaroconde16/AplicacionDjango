...
7. La aplicación estará corriendo en `http://127.0.0.1:8000/`.
...
2. Realiza un **GET** a la URL para listar las reservas.
   - **Endpoint:** `GET http://127.0.0.1:8000/api/v1/reservas/listar_usuario/`
   - **Encabezados (Headers):**
     ```bash
...
1. Realiza un **POST** a la URL para crear una nueva reserva.
   - **Endpoint:** `POST http://127.0.0.1:8000/api/v1/reservas/crear/`
   - **Encabezados (Headers):**
     ```bash
     Authorization: Bearer <tu_token>
...
1. Realiza un **PUT** a la URL para actualizar una reserva existente.
   - **Endpoint:** `PUT http://127.0.0.1:8000/api/v1/reservas/editar/<id_reserva>/`
   - **Encabezados (Headers):**
     ```bash
     Authorization: Bearer <tu_token>
     Content-Type: application/json
...
1. Realiza un **DELETE** a la URL para eliminar una reserva existente.
   - **Endpoint:** `DELETE http://127.0.0.1:8000/api/v1/reservas/eliminar/<id_reserva>/`
   - **Encabezados (Headers):**
     ```bash
     Authorization: Bearer <tu_token>
     ```
...
1. Realiza un **PATCH** a la URL para actualizar parcialmente una reserva.
   - **Endpoint:** `PATCH http://127.0.0.1:8000/api/v1/reservas/actualizar_codigo/<id_reserva>/`
   - **Encabezados (Headers):**
     ```bash
     Authorization: Bearer <tu_token>
     Content-Type: application/json
